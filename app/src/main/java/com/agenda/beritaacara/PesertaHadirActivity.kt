...
import com.agenda.beritaacara.http.PesertaHadirHttp
import com.journeyapps.barcodescanner.ScanContract
import com.journeyapps.barcodescanner.ScanOptions

class PesertaHadirActivity : AppCompatActivity(), PesertaAdapter.ListnerePesertaAdapter {
    ...
    private fun sendData(nama : String){
        ...
        val pesertaHadirHttp : PesertaHadirHttp = PesertaHadirHttp(this)
        pesertaHadirHttp.store(idBeritaAcara, nama){
    ...
    private fun showCamera() {
        ...
        options.setPrompt("Scan QRCode Peserta Hadir")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_peserta_hadir)
        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        supportActionBar!!.title = "Daftar Peserta Hadir"
        idBeritaAcara = intent.getStringExtra("ID_BERITA_ACARA")?.toInt()

        onBackPressedDispatcher.addCallback(this, onBackPressedCallback )

        rvPeserta = findViewById(R.id.rv_peserta_hadir)
        btnScan = findViewById(R.id.btn_scan_hadir)
    ...
    private fun setList() {
        ...
        val pesertaHadirHttp : PesertaHadirHttp = PesertaHadirHttp(this)
        pesertaHadirHttp.send(idBeritaAcara){
    ...
    override fun onDelete(id: Int) {
        val pesertaHadirHttp : PesertaHadirHttp = PesertaHadirHttp(this)
        pesertaHadirHttp.deleted(idBeritaAcara, id){ result ->
